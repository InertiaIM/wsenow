...
class SyncCommand extends ContainerAwareCommand
{
    ...
    protected function setupSfClient()
    {
        $this->uploadDir = $this->getContainer()->getParameter('sf_upload_dir');

        $this->user = $this->getContainer()->getParameter('sf_user');
        $this->password = $this->getContainer()->getParameter('sf_password');
        $this->sfConnection = new \SforcePartnerClient();
        $this->soapClient = $this->sfConnection->createConnection(
            $this->getContainer()->getParameter('sf_wsdl_path')
        );
